...
by accessing the static properties of Draw_Froces  (this is not really the correct way to do this but I will change it)
...
Here the Slot Info Multiton only has 2 info obects, one used in instancing the drawing distortion quads and one for force quad s.

This all relies too much on static initialization and in general won't stay like this but I was trying to get the effect to work fast (a prototype) and be flexible to change so that I could experiment with it.
