...
( copy of the information on them from classes.txt
...
	//this specifies the characteristics of the force, it's used in insancing along with a mesh describing the shape of the area where the forces are placed 
	Force_Draw_Instance 
...
The write operation arrows also have an A or O on them to indicative the blending mode (Additive Opaque etc.)
